  ...
  return (
    <div className="main-container">
      ...
      <div className="max-w-md w-full mx-auto px-6 py-8 rounded-2xl border border-border bg-secondary shadow-card">
        <h1 className="text-3xl font-bold bg-gradient-primary bg-clip-text text-transparent mb-2 text-center">Sign In</h1>
        <p className="text-muted-foreground text-center mb-6">Welcome back. Enter your credentials.</p>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="mt-2 text-right text-xs"><Link to="/forgot" className="underline text-muted-foreground">Forgot password?</Link></div>
          </div>
          <button className="btn-primary w-full bg-gradient-button" disabled={loading}>{loading ? 'Signing in...' : 'Sign In'}</button>
        </form>
